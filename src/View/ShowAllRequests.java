...
public class ShowAllRequests extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("All User Requsets");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "U_SSN", "Name", "Age", "MartilaStatus", "Adress", "Mobile", "Sex"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowAllRequests.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowAllRequests().setVisible(true);
            }
        });
    }
